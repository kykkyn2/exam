...
public class XlsxRead {
	...
	public static void main(String[] args) {
		...
		try {
			//FileInputStream inputStream = new FileInputStream("ooxml-cell.xlsx");
			FileInputStream inputStream = new FileInputStream("kykkyn2.xlsx");
			...
			for (int cn = 0; cn < sheetCn; cn++) {
				...
				for (int r = 0; r < rows; r++) {
					...
					if (row != null) {
						for (int c = 0; c < sheet.getRow(cn).getPhysicalNumberOfCells(); c++) {
